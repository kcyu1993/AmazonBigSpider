...
都有回答，而且还帮别人搭了几套规模小的(腾讯云|阿里云)，收了两三千的辛苦费，搭机器和在跑的过程不断地发现BUG，并且不断地FIX BUG和加新功能。
...
PS：其实在China，这种版权很多人直接忽视，悄悄拿去用（但我希望你是一个尊重别人劳动成果的人）。这篇文章[为什么我的代码进入闭源状态](http://www.yinwang.org/blog-cn/2017/04/18/close-source)希望能够撼动你的心灵。
